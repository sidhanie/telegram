...
def unknown(update,context):
    ...
    #Special command
    if pesan.split()[0] == "!off" and cek.username == "APPSLEOBOT":
    ...
    elif pesan.split()[0] == "!on" and cek.username == "APPSLEOBOT":
    ...
    elif pesan.split()[0] == "!del" and cek.username == "APPSLEOBOT":
        dell=update.message
        mssi=dell['reply_to_message']['message_id']
        time.sleep(1)
        context.bot.delete_message(chat_id=cid,message_id=mssi)
    elif pesan.split()[0] == "!rdebug" and cek.username == "APPSLEOBOT":
        msu=update.message
    ...
    if pesan.split()[0] == "!up" and cek.username == "APPSLEOBOT":
        ...
        return True
    elif pesan.split()[0] == "!get" and cek.username == "APPSLEOBOT":
        ...
        return True
    elif pesan[0] == "!" and cek.username == "APPSLEOBOT":
...
def main():
    updaterr = Updater(('1901705153:AAFmTKE2sYXxJLo4IcdXA6duWUNRG11new0'),use_context=True)
